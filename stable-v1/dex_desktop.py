...
class DexDesktop:
    ...
    def draw(self, now):
        ...
        tail_y = body_y + 5 + wag
        self.rect(12, tail_y + 1, 13, 5, outline)
        self.rect(10, tail_y - 2, 9, 5, outline)
        self.rect(13, tail_y, 11, 3, charcoal)
        self.rect(10, tail_y - 2, 5, 3, warm_grey)

        self.rect(head_x - 2, head_y + 1, 20, 18, outline)
        self.rect(head_x, head_y, 17, 17, charcoal)
        self.rect(head_x + 3, head_y - 4, 12, 7, outline)
        self.rect(head_x + 4, head_y - 5, 10, 6, shine)
        self.rect(head_x + 7, head_y + 8, 10, 8, grey)
        self.rect(head_x + 10, head_y + 11, 7, 5, warm_grey)
        self.rect(head_x + 13, head_y + 12, 3, 2, "#0d0d0d")
        ...
        if laying:
            self.rect(head_x + 9, head_y + 6, 4, 1, eye)
            self.rect(70, 16 - pant, 4, 2, "#d8d4cc")
            self.rect(77, 12 - pant, 3, 1, "#d8d4cc")
        else:
            self.rect(head_x + 9, head_y + 6, 2, 2, eye)
            self.rect(head_x + 10, head_y + 6, 1, 1, eye_glint)
